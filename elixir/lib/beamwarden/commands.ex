defmodule Beamwarden.CommandExecution do
  @moduledoc false
  defstruct [:name, :source_hint, :prompt, :handled, :message]
end

defmodule Beamwarden.Commands do
  @moduledoc false

  alias Beamwarden.{CommandExecution, PortingBacklog, PortingModule}

  @ported_commands Enum.map(Beamwarden.ReferenceData.commands_snapshot(), fn entry ->
                     %PortingModule{
                       name: entry["name"],
