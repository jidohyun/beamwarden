defmodule Beamwarden.PortContext do
  @moduledoc false
  defstruct [
    :source_root,
    :tests_root,
...
defmodule Beamwarden.Context do
  @moduledoc false

  alias Beamwarden.PortContext

  def build(_base \\ Beamwarden.project_root()) do
    source_root = Beamwarden.source_root()
    tests_root = Beamwarden.test_root()
    assets_root = Beamwarden.assets_root()
    archive_root = Beamwarden.archive_root()
