defmodule ClawCode.ParityAuditResult do
  @moduledoc false
...
defmodule ClawCode.ParityAudit do
  @moduledoc false

  alias ClawCode.ParityAuditResult
  ...
  def run do
    ...
    reference = ClawCode.ReferenceData.archive_surface_snapshot()
    current_elixir_files = count_source_files()

    %ParityAuditResult{
      archive_present: File.dir?(ClawCode.archive_root()),
      ...
      command_entry_ratio:
        {length(ClawCode.ReferenceData.commands_snapshot()), reference["command_entry_count"]},
      tool_entry_ratio:
        {length(ClawCode.ReferenceData.tools_snapshot()), reference["tool_entry_count"]},
