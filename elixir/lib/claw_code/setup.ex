defmodule ClawCode.WorkspaceSetup do
  @moduledoc false
...
defmodule ClawCode.SetupReport do
  @moduledoc false
  ...
  def as_markdown(%__MODULE__{} = report) do
    [
      ...
      "",
      "Deferred init:",
      ClawCode.DeferredInitResult.as_lines(report.deferred_init)
    ]
    |> List.flatten()
    |> Enum.join("\n")
  end
...
defmodule ClawCode.Setup do
  @moduledoc false

  alias ClawCode.{DeferredInit, Prefetch, SetupReport, WorkspaceSetup}
  ...
  def run(cwd \\ ClawCode.repo_root(), trusted \\ true) do
    %SetupReport{
