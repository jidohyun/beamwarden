defmodule ClawCode.ToolExecution do
  @moduledoc false
  defstruct [:name, :source_hint, :payload, :handled, :message]
end

defmodule ClawCode.Tools do
  @moduledoc false

  alias ClawCode.{PortingBacklog, PortingModule, ToolExecution, ToolPermissionContext}

  @ported_tools Enum.map(ClawCode.ReferenceData.tools_snapshot(), fn entry ->
                  %PortingModule{
                    name: entry["name"],
